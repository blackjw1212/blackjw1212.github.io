...
test("root index is an entry console", async () => {
  ...
  assert.deepEqual(primaryLinks, [["stocks", "/stocks/"], ["weather", "/weather/"], ["esp32", "/esp32/"], ["forscan", "/forscan/"], ["flight", "/flight/"], ["dash", "/dash/"], ["coupon", "/coupon/"], ["subtitle", "/subtitle/"], ["convert", "/convert/"], ["bait", "/bait/"], ["float", "/float/"]]);
